<?php
require "./db.php" ;
$products = $db->query("select * from product2")
...
<head>
    ...
    <link rel="stylesheet" href="sass/utils.css?v=<?php echo time(); ?>">
</head>
<body>
    ...
    <!-- start #main-site -->
        <main id="main-site">
          ...
          <!-- !Owl-carousel -->
          <!--Primary Navigation-->
          <nav class="primaryNav flex" >
              <ul class="menuItems m-auto font-rubik flex">
                <li><a href='?onsale=1' data-item='On Sale' style="<?= isset($_GET["onsale"]) ? "color:rgb(239, 87, 87);" : "" ?>">On Sale</a></li>
                <li><a href='?products=1' data-item='Products' style="<?= isset($_GET["products"]) ? "color:rgb(239, 87, 87);" : "" ?>">Products</a></li>
                <li><a href='?comingsoon=1' data-item='Coming Soon' style="<?= isset($_GET["comingsoon"]) ? "color:rgb(239, 87, 87);" : "" ?>">Coming Soon</a></li>
                <li><a href='?blog=1' data-item='Blog' style="<?= isset($_GET["blog"]) ? "color:rgb(239, 87, 87);" : "" ?>">Blog</a></li>
                <li><a href='?contact=1' data-item='Contact' style="<?= isset($_GET["contact"]) ? "color:rgb(239, 87, 87);" : "" ?>">Contact</a></li>
              </ul>
              <form action="#" class="font-size-14 font-rale">
                  <a href="#" class="py-2 mx-2">
                    <span class="font-size-16 px-2 text-dark"><i class="fas fa-filter"></i></span>
                  </a>
              </form>
          </nav>
      <!-- !Primary Navigation -->
            ...
            <div class="container py-5">
              ...
              <!-- owl carousel -->
                <div class="owl-carousel owl-theme">
                  ...
                  echo "<div class='item py-2'>";  
                   echo "<div class='product font-rale'>";
                      echo "<div class=\"d-flex flex-column\">";
                        echo "<a href='#'><img src='assets/products/{$product['image']}' class='img-fluid' alt='pro1'></a>";
                        echo "<div class=\"text-center\">";
                          echo "<h6>{$products[1]['pname']}</h6>";
                          echo "<div class=\"rating text-warning font-size-12\">";
                            for($k=1; $k<=$product["rating"];$k++){
                            echo "<span><i class=\"fas fa-star\"></i></span>";}
                            for($k=0;$k<5-$product["rating"];$k++){
                            echo "<span><i class=\"far fa-star\"></i></span>";}
                          echo "</div>";
                          echo "<div class=\"price py-2\">";
          ...
          <section id="special-price">
            <div class="container">
              ...
              <div class="grid">
                ...
                if($product["on_sale"]==1 && $product["price"]<200){
                 
                echo "<div class=\"grid-item {$product['company']} border\" >";
                  echo "<div class=\"item py-2\" style=\"width: 200px;\">";
                    echo "<div class=\"product font-rale\">";
                      echo "<div class=\"d-flex flex-column\">";
                        echo "<a href=\"#\"><img src=\"assets/products/{$product['image']}\" class=\"img-fluid\" alt=\"pro1\"></a>";
                        echo "<div class=\"text-center\">";
                          echo "<h6>{$product['pname']}</h6>";
                          echo "<div class=\"rating text-warning font-size-12\">";
                          for($k=1; $k<=$product["rating"];$k++){
                            echo "<span><i class=\"fas fa-star\"></i></span>";}
                            for($k=0;$k<5-$product["rating"];$k++){
          ...
          <section id="new-phones">
            <div class="container">
              ...
              <hr>
                    <div class="owl-carousel owl-theme">
                    <?php foreach($products as $product){
                      if($product["on_sale"]==1 && $product["price"]>=150){
                      echo "<div class=\"grid-item {$product['company']} border\" >";
                        echo "<div class=\"item py-2\" style=\"width: 200px;\">";
                          echo "<div class=\"product font-rale\">";
                            echo "<div class=\"d-flex flex-column\">";
